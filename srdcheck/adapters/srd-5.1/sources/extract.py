#!/usr/bin/env python3
"""Extract SRD 5.1 (2014) text per page and build a heading index.

Parallel to the srd-5.2.1 extractor so both editions are searchable side by side
(see scripts/srd_index.py). Outputs (gitignored, derived from the pinned PDF):
