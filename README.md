...
- **Scope and provenance travel with the verdict.** Verdict schema 3.0 keeps
...
|---|---|---|---|
| T1 | wrong verdicts | enforced in CI | 668 tests including gold suites ported from the Phase 0 eval; any wrong verdict fails the build |
