...
| `srd-5.2.1` | `0.2.1` | `0.2.1` | `0.2.1` | `4412cb3b1c32…` |
...
| `attack_modifiers` | Compose modeled attack modifiers from structured combatant facts. | documented condition modifiers; Prone distance behavior; ranged attacks in close combat | cover and line-of-sight geometry; weapon or feature prerequisites; facts the caller did not supply | `tests/test_roll_modifiers.py::test_prone_target_distance_flip`; `tests/test_roll_modifiers.py::test_ranged_in_close_combat_disadvantage_and_exceptions`; `tests/test_roll_modifiers.py::test_target_petrified_and_unconscious_grant_advantage` |
...
| `check_make` | Compose or resolve an ability check from caller-supplied facts and roll. | DC comparison; modeled condition and social modifiers; supplied d20 and modifiers | rolling dice; choosing a DC; deriving modifiers; narrative outcome | `tests/test_checks.py::test_poisoned_and_frightened_impose_disadvantage_on_checks`; `tests/test_checks.py::test_blinded_auto_fails_sight_checks_only` |
