...
CONDITION_EFFECTS = {
    ...
    "Exhaustion": [(M, "condition.exhaustion.d20-penalty"),
                   (D, "graduated-speed"), (D, "save-ability-typing")],
    ...
    "Unconscious": [(M, "condition.unconscious.inert"),
                    ...
                    (D, "save-ability-typing"), (N, "unaware of surroundings")],
}
